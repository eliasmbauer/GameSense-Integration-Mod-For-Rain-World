...
namespace Rain_World_GameSense
{
    ...
    public class GameSense_Mod : BaseUnityPlugin
    {
        ...
        private static readonly int RGBUpdateRate = 10; // determines how many in game ticks before the light manager gets an update (A rate of 10 means 1 RGB update per 10 in-game updates)
        private bool IsInit;
